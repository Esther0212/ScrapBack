...
const CartonDetail = () => {
  ...
  const dosList = [
    "Do flatten cartons to save space.",
    "Do rinse out food or drink residue.",
    "Do remove straws or plastic linings if possible.",
    "Do check if your local recycling program accepts cartons.",
    "Do separate by type if required.",
  ];

  const dontsList = [
    "Don't recycle cartons with heavy contamination.",
    "Don't mix cartons with non-recyclable waste.",
    "Don't burn cartons.",
    "Don't throw cartons in regular trash bins if recycling is available.",
  ];
      ...
      <View style={styles.card}>
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 20 }}>
          ...
          <Pressable style={styles.yellowButton}>
            <Text style={styles.yellowButtonText}>Carton container</Text>
          </Pressable>
